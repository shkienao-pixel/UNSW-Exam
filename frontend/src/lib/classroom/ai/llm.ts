...
import type { ProviderType, ThinkingCapability, ThinkingConfig } from '@/lib/classroom/types/provider';
const log = createLogger('LLM');

// Re-export for external use
export type { ThinkingConfig } from '@/lib/classroom/types/provider';
