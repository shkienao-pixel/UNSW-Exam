...
import { CLASSROOMS_DIR } from '@/lib/classroom/server/classroom-storage';
import { generateImage } from '@/lib/classroom/media/image-providers';
import { generateVideo, normalizeVideoOptions } from '@/lib/classroom/media/video-providers';
import { generateTTS } from '@/lib/classroom/audio/tts-providers';
import { DEFAULT_TTS_VOICES, DEFAULT_TTS_MODELS, TTS_PROVIDERS } from '@/lib/classroom/audio/constants';
import { IMAGE_PROVIDERS } from '@/lib/classroom/media/image-providers';
import { VIDEO_PROVIDERS } from '@/lib/classroom/media/video-providers';
import { isMediaPlaceholder } from '@/lib/classroom/store/media-generation';
import {
  ...
  resolveTTSApiKey,
  resolveTTSBaseUrl,
} from '@/lib/classroom/server/provider-config';
import type { SceneOutline } from '@/lib/classroom/types/generation';
import type { Scene } from '@/lib/classroom/types/stage';
import type { SpeechAction } from '@/lib/classroom/types/action';
import type { ImageProviderId } from '@/lib/classroom/media/types';
import type { VideoProviderId } from '@/lib/classroom/media/types';
import type { TTSProviderId } from '@/lib/classroom/audio/types';
import { splitLongSpeechActions } from '@/lib/classroom/audio/tts-utils';
