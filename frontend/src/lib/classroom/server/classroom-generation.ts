...
import { callLLM } from '@/lib/classroom/ai/llm';
import { createStageAPI } from '@/lib/classroom/api/stage-api';
import type { StageStore } from '@/lib/classroom/api/stage-api-types';
import {
  applyOutlineFallbacks,
  generateSceneOutlinesFromRequirements,
} from '@/lib/classroom/generation/outline-generator';
import {
  createSceneWithActions,
  generateSceneActions,
  generateSceneContent,
} from '@/lib/classroom/generation/scene-generator';
import type { AICallFn } from '@/lib/classroom/generation/pipeline-types';
import type { AgentInfo } from '@/lib/classroom/generation/pipeline-types';
import { formatTeacherPersonaForPrompt } from '@/lib/classroom/generation/prompt-formatters';
import { getDefaultAgents } from '@/lib/classroom/orchestration/registry/store';
import { createLogger } from '@/lib/classroom/logger';
import { parseModelString } from '@/lib/classroom/ai/providers';
import { resolveApiKey, resolveWebSearchApiKey } from '@/lib/classroom/server/provider-config';
import { resolveModel } from '@/lib/classroom/server/resolve-model';
import { searchWithTavily, formatSearchResultsAsContext } from '@/lib/classroom/web-search/tavily';
import { persistClassroom } from '@/lib/classroom/server/classroom-storage';
import {
  generateMediaForClassroom,
  replaceMediaPlaceholders,
  generateTTSForClassroom,
} from '@/lib/classroom/server/classroom-media-generation';
import type { UserRequirements } from '@/lib/classroom/types/generation';
import type { Scene, Stage } from '@/lib/classroom/types/stage';
