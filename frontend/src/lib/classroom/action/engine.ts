...
import type { StageStore } from '@/lib/classroom/api/stage-api';
import { createStageAPI } from '@/lib/classroom/api/stage-api';
import { useCanvasStore } from '@/lib/classroom/store/canvas';
import { useWhiteboardHistoryStore } from '@/lib/classroom/store/whiteboard-history';
import { useMediaGenerationStore, isMediaPlaceholder } from '@/lib/classroom/store/media-generation';
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const getClientTranslation = (key: string): string => key;
import type { AudioPlayer } from '@/lib/classroom/utils/audio-player';
import type {
  Action,
  SpotlightAction,
  LaserAction,
  ...
  WbDeleteAction,
  WbDrawLineAction,
} from '@/lib/classroom/types/action';
