...
import { createSelectors } from '@/lib/classroom/utils/create-selectors';
import type { TextAttrs } from '@/lib/classroom/prosemirror/utils';
import { defaultRichTextAttrs } from '@/lib/classroom/prosemirror/utils';
import type { TextFormatPainter, ShapeFormatPainter, CreatingElement } from '@/lib/classroom/types/edit';
import type { PercentageGeometry } from '@/lib/classroom/types/action';
