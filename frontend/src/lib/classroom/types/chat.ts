...
import type { Stage, Scene, StageMode } from '@/lib/classroom/types/stage';
import type { AgentTurnSummary, WhiteboardActionRecord } from '@/lib/classroom/orchestration/director-prompt';
