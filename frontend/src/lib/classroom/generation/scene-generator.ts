...
import { MAX_VISION_IMAGES } from '@/lib/classroom/constants/generation';
import type {
  SceneOutline,
...
import type { PPTElement, Slide, SlideBackground, SlideTheme } from '@/lib/classroom/types/slides';
import type { QuizQuestion } from '@/lib/classroom/types/stage';
import type { Action } from '@/lib/classroom/types/action';
import type {
  AgentInfo,
