...
import type { SlideContent } from '@/lib/classroom/types/stage';
import type { SlideTheme, SlideBackground } from '@/lib/classroom/types/slides';
...
export function createCanvasAPI(store: StageStore) {
  return {
    ...
    setSpotlightPercentage(
      sceneId: string,
      elementId: string,
      geometry: import('@/lib/classroom/types/action').PercentageGeometry,
      options: SpotlightOptions = {},
    ): APIResult<boolean> {
      try {
        const canvasStore = useCanvasStore.getState();
    ...
    setLaser(
      ...
      elementId: string,
      geometry: import('@/lib/classroom/types/action').PercentageGeometry,
      options: import('@/lib/classroom/store/canvas').LaserOptions = {},
    ): APIResult<boolean> {
      try {
        const canvasStore = useCanvasStore.getState();
