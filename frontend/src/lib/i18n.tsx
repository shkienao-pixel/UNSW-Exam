...
const dict = {
  ...
  credits_estimator_item_1: { zh: 'AI 文件摘要', en: 'AI Summary' },
  credits_estimator_cost_1: { zh: '1 积分 / 份', en: '1 credit / file' },
  credits_estimator_value_1: { zh: '全文提炼核心知识点，生成结构化 Markdown 摘要', en: 'Extract key points and generate structured Markdown summary' },
  credits_estimator_item_2: { zh: 'AI 大纲生成', en: 'AI Outline' },
  credits_estimator_cost_2: { zh: '5 积分 / 份', en: '5 credits / file' },
  credits_estimator_value_2: { zh: '自动梳理课程知识框架，生成层级考点大纲', en: 'Auto-structure course knowledge into hierarchical outline' },
  credits_estimator_item_3: { zh: '考前复习计划', en: 'Exam Planner' },
  credits_estimator_cost_3: { zh: '5 积分 / 次', en: '5 credits / plan' },
  credits_estimator_value_3: { zh: '基于考试日期生成每日备考安排，追踪进度', en: 'Generate daily study schedule based on exam date' },
  credits_estimator_item_4: { zh: 'AI 深度追问', en: 'AI Deep Follow-up' },
  credits_estimator_cost_4: { zh: '20 积分 / 次', en: '20 credits / round' },
  credits_estimator_value_4: { zh: '围绕疑难点进行高精度、长上下文互动（Gemini 3.1 Pro）', en: 'High-precision long-context Q&A powered by Gemini 3.1 Pro' },
  credits_estimator_item_5: { zh: '解锁并解析文件', en: 'Unlock + Parse File' },
  credits_estimator_cost_5: { zh: '50 积分 / 份', en: '50 credits / file' },
  credits_estimator_value_5: { zh: '解锁全文阅读权限 + AI 自动建立向量索引', en: 'Unlock full access + build AI vector index' },
  credits_estimator_item_6: { zh: '选课报名', en: 'Course Enroll' },
  credits_estimator_cost_6: { zh: '100 积分 / 门', en: '100 credits / course' },
  credits_estimator_value_6: { zh: '加入课程，访问所有共享课件与 AI 功能', en: 'Join course and access all shared materials and AI features' },
  credits_estimator_item_7: { zh: 'AI 闪卡生成', en: 'AI Flashcards' },
  credits_estimator_cost_7: { zh: '100 积分 / 套', en: '100 credits / set' },
  credits_estimator_value_7: { zh: '生成词汇卡 + MCQ 卡，支持错题记录与复习', en: 'Generate vocab + MCQ cards with mistake tracking' },
  credits_estimator_item_8: { zh: 'AI 模拟练习题', en: 'AI Quiz' },
  credits_estimator_cost_8: { zh: '100 积分 / 套', en: '100 credits / set' },
  credits_estimator_value_8: { zh: '基于课件出题，含选项与详细解析', en: 'Course-grounded quiz with options and explanations' },
  credits_estimator_item_9: { zh: '全真模拟试卷', en: 'Full Mock Exam' },
  credits_estimator_cost_9: { zh: '100 积分 / 套', en: '100 credits / set' },
  credits_estimator_value_9: { zh: '对标历年真题逻辑，生成含解析的完整考卷', en: 'Past-exam aligned full paper with explanations' },
  credits_estimator_item_10: { zh: '往年真题解锁', en: 'Past Exam Unlock' },
  credits_estimator_cost_10: { zh: '150 积分 / 套', en: '150 credits / set' },
  credits_estimator_value_10: { zh: '永久解锁完整真题卷 + AI 逐题详解 + 高频考点标注', en: 'Permanent access to past paper + AI explanations + key highlights' },
  credits_estimator_item_11: { zh: 'AI 互动课堂', en: 'AI Classroom' },
  credits_estimator_cost_11: { zh: '300 积分 / 节', en: '300 credits / session' },
  credits_estimator_value_11: { zh: '多轮对话式教学，模拟课堂讲解与互动问答', en: 'Multi-turn interactive teaching simulation with Q&A' },
