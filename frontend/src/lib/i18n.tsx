...
const dict = {
  ...
  credits_estimator_cost_3: { zh: '30 积分 / 次', en: '30 credits / round' },
  credits_estimator_value_3: { zh: '围绕疑难点进行高精度、长上下文互动', en: 'High-precision long-context discussion on difficult points' },
  credits_estimator_item_4: { zh: '往年真题解锁', en: 'Past Exam Unlock' },
  credits_estimator_cost_4: { zh: '150 积分 / 套', en: '150 credits / set' },
  credits_estimator_value_4: { zh: '解锁完整真题卷 + AI 逐题详解 + 高频考点标注', en: 'Full past paper access + AI explanations + key-point highlights' },
