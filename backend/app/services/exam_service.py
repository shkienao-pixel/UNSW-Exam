...
_VISION_SYSTEM = (
    ...
    "  3. For MCQ: list options as plain text (strip any leading label like \"A.\", \"(A)\", \"A)\" etc.).\n"
    "     Always set correct_answer to the correct option letter (A/B/C/D):\n"
    "     - If an answer key is visible on the page, use it.\n"
    "     - Otherwise, use your knowledge to determine the correct answer.\n"
    "     Never leave correct_answer as null for MCQ.\n"
    "  4. For short_answer: set correct_answer to a concise reference answer if clearly shown or inferable; otherwise null.\n"
...
def extract_questions_from_artifact(
    ...
    system = (
        ...
        "   Always set correct_answer to the correct option letter (A/B/C/D):\n"
        "   - If an answer key is present in the paper, use it.\n"
        "   - Otherwise, use your knowledge to determine the correct answer.\n"
        "   Never leave correct_answer as null for MCQ.\n"
...
def _grade_short_answers_batch(
    ...
    system = (
        ...
        "   - If INCORRECT: in each language, state (a) the correct answer, "
        "(b) why the student's choice is wrong, (c) a concise concept explanation. "
        "Minimum 2 sentences per language for incorrect answers.\n"
